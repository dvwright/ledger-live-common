...
export type ExtraDeviceTransactionField =
  | { type: "solana.delegateValidators", label: string }
  | { type: "solana.validatorName", label: string }
  | { type: "solana.sourceValidatorName", label: string };
...
function getDeviceTransactionConfig({
  ...
  switch (mode) {
    ...
    case "delegate":
      ...
      fields.push({
        type: "solana.delegateValidators",
        label: "Validators",
      });
      break;
    ...
    case "redelegate":
      ...
      fields.push({
        type: "solana.sourceValidatorName",
